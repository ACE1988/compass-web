...
import static com.sdxd.common.utils.ValidatorRegexTmplUtils.REGEX_EMAIL;
 ...
 */
public class CreateAdminRequest extends RestRequest {
    @ApiParam(value = "账号")
    ...
    @ApiParam(value = "密码")
    @NotEmpty(message = "未填写 password")
    @Pattern(regexp = "[a-z|A-Z|\\d]+", message = "password 只能由a-z, A-Z或 数字组成")
    @Length(min = 6, max = 20, message = "password 的长度是6-20")
